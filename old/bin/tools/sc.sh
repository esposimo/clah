...
usage()
{
    printf "\nUsage: clah sc ACTION PATH VALUE\n";
    printf "\n"
...
usage_put()
{
    ...
    printf "\nUsage: clah sc put PATH VALUE\n\n";
    printf "Example: ";
    printf "clah sc put custom_app/endpoint http://localhost:8080\tPut value http://localhost:8080 in key custom_app/endpoint\n";
    printf "\n";
}
...
usage_get()
{
    ...
    printf "Example: ";
    printf "clah sc get custom_app/endpoint\t Show value in the path custom_app/endpoint\n";
    printf "\n";
}
usage_ls()
{
    ...
    printf "Example: ";
    printf "clah sc ls custom_app\t Show all keys in the path custom_app\n";
    printf "         clah sc ls\t\t Show all keys in the service config\n";
    printf "\n";
}
...
usage_rm()
{
    ...
    printf "\nUsage: clah sc rm PATH\n\n";
    printf "Example: ";
    printf "clah sc rm custom_app\t\t Remove path custom_app and its subkeys from service config\n";
    printf "\n";
}
...
usage_lget()
{
    ...
    printf "Example: ";
    printf "clah sc lget custom_app\t Show all keys and values in path custom_app\n";
    printf "         clah sc lget\t\t\t Show all keys and values in service config\n";
    printf "\n";
}
...
case "$COMMAND" in
    put)
        ...
        shift 1;
        KEY_VALUE=$*
        get_kv_docker $KEY_NAME $KEY_VALUE
        exit;
        ;;
    get)
        KEY_NAME=$1
    ...
    rm)
        ...
        rm_kv_docker $KEY_NAME
        exit;
        ;;
    lget)
        KEY_NAME=$1
        lget_kv_docker $KEY_NAME
        exit;
        ;;
    help)
        KEY_NAME=$1
